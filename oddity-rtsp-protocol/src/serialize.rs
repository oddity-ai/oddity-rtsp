...
use super::{
    error::{Error, Result},
    message::{Method, StatusCode, Uri, Version},
    request::Request,
    response::Response,
};
...
mod tests {
    ...
    use crate::{message::Message, request::RequestMetadata, response::ResponseMetadata};

    use super::{Error, Method, Request, Response, Serialize, Version};
